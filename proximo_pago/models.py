...
class ProximoPago(models.Model):
    cliente = models.ForeignKey(Cliente, on_delete=models.PROTECT, verbose_name='Cliente')
    fecha = models.DateField(verbose_name='Fecha')
    estado = models.CharField(max_length=10, choices=[('PENDIENTE', 'PENDIENTE'), ('PROCESADA', 'PROCESADA'), ('CANCELADA', 'CANCELADA')], verbose_name='Estado', default='PENDIENTE')
    ...
    class Meta:
        ...
        verbose_name_plural = 'Próximos Pagos'
